...
var madLib = "'The Intro to JavaScript course is amazing. James and Julia are so fun. I cannot wait to work through the rest of this entertaining content!'\n Directions:\n Mad Libs is a word game where players have fun substituting words for blanks in a story. For this exercise, use the adjective variables below to fill in the blanks and complete the following message.\"The Intro to JavaScript course is\t \". James and Julia are so \t . I cannot wait to work through the rest of this \t \"content!\" \n \"var adjective1 = amazing;\" \n var adjective2 = \"fun; \" \n var adjective3 = \"entertaining; \" \n Assign the resulting string to a variable called madLib.";
